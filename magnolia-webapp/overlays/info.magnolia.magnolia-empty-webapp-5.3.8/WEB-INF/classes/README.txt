...
This package contains:
   ...
   Magnolia Core 5.3.8
   Magnolia Internationalization Framework 5.3.8
   Magnolia JAAS 5.3.8
   Magnolia Imaging Module 3.1.3
   Magnolia Legacy UI 5.2.3
   Magnolia Rendering 5.3.8
   Magnolia Templating 5.3.8
   Magnolia Templating for JSP 5.3.8
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.3.8.html
...
Copyright 2003-2015 Magnolia International Ltd.
